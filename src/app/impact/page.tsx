          ...
          <div className="grid md:grid-cols-2 gap-12 lg:gap-16 items-center">
            <div>
              ...
              <p className="mt-4 text-muted-foreground text-lg">
                KEF’s impact spans all 47 counties in Kenya. Our interactive map shows a story of nationwide reach, connecting students from remote villages to top schools and, eventually, to global opportunities.
              </p>
