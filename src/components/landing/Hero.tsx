    ...
    <div className="relative w-full h-screen flex items-center justify-center text-center overflow-hidden">
      ...
      <div className="relative z-20 flex flex-col items-center px-4 text-white">
        <motion.h1
          ...
          className="text-4xl md:text-6xl font-bold text-white hero-glow"
        >
        ...
        >
          Education is the bridge to opportunity. Step into the shoes of a donor
          and see how your choices can unlock futures.
        </motion.p>
